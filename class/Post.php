<?php
 class Post {
                   ...
                   // $rand = rand(5,7);
                    $str .= "<div class='col-12 col-lg-5'>
                            <div class='single-blog-post featured-post-2'>
                                ...
                                <div class='post-data'>
                                    <a href='category.php?c_id=$cat_id' class='post-catagory'>$cat_title</a>
                                    <div class='post-meta'>
     ...
     public function getFeaturedNews()
        {
            $query = mysqli_query($this->conn, "SELECT * FROM news ORDER BY date DESC LIMIT 5");
            $str = "";
            while ($row = mysqli_fetch_array($query)) {
                $id = $row['id'];
                $image = $row['post_image'];
     ...
     public function getCasualNews()
        ...
        {
            $query = mysqli_query($this->conn, "SELECT * FROM news WHERE content LIKE '%$keyword%' ORDER BY id DESC LIMIT 10");
            $str = "";
