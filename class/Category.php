               ...
               while ($row = mysqli_fetch_array($query)) {
                    ...
                    $str .= "<div class='col-12 col-md-6'>
                            <div class='single-blog-post style-3'>
                                ...
                                <div class='post-data'>
                                    <a href='category.php?c_id=$cat_id' class='post-catagory'>$category</a>
                                    <a href='single-post.php?post_id=$id&cat_r=$category' class='post-title'>
                                        <h6>$content</h6>
                                    </a>
                                    <div class='post-meta d-flex align-items-center'>
                                        <a href='category.php?c_id=$cat_id&like_id=$id' class='post-like'><img src='img/core-img/like.png'> <span>$num_likes</span></a>
